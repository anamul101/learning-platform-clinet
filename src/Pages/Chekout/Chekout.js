    ...
    return (
        ...
        <h1 className='text-center font-bold text-4xl text-dark text-blue-700 mt-8'>Checkout</h1>
         <div className="divider"></div>
                {/* ============================================================================ */}
        <div className='lg:flex justify-between mt-8 mb-8 lg:mx-20'>
            
            <div className=' lg:w-2/5 flex justify-center mt-8'>
            ...
            {/* ================================================================================ */}
            <div className='border rounded-md py-8 mt-8 lg:ml-8 lg:w-3/5 rboder-2 border-indigo-600 '>
            ...
            <div className="card w-96 mx-auto bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <p className='mt-2 text-bold text-2xl'>Price: ${price}</p>
                </div>
